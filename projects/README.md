...
<!--
 ...
 -->
 python train_net.py --num-gpus 1 --config-file configs/CenterNet2_R2-101-DCN-BiFPN_1280_4x.yaml --resume
 python train_net.py --num-gpus 1 --config-file configs/CenterNet2_v19_slim_FPN.yaml --resume

 python demo.py --config-file configs/CenterNet2_v19_slim_FPN.yaml --input images/ --opts MODEL.WEIGHTS output/CenterNet2/CenterNet2_v19_slim_FPN/model_0083999.pth
 python demo.py --config-file configs/CenterNet2_R2-101-DCN-BiFPN_1280_4x.yaml --input images/ --opts MODEL.WEIGHTS output/CenterNet2/CenterNet2_R2-101-DCN-BiFPN_1280_4x/model_final.pth
