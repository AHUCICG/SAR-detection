...
$ ./analyze_model.py --tasks parameter  --config-file ../configs/COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml
 ./analyze_model.py --tasks parameter  --config-file ../configs/COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml
 python analyze_model.py --tasks parameter --config-file ../projects/CenterNet2/configs/CenterNet2_R2-101-DCN-BiFPN_1280_4x.yaml 
 python analyze_model.py --tasks parameter --config-file ../projects/CenterNet2/configs/CenterNet2_Mv2-BiFPN_1280_4x.yaml
...
$ ./analyze_model.py --num-inputs 100 --tasks flop \\
   ...
   python analyze_model.py --num-inputs 100 --tasks flop  --config-file ../projects/CenterNet2/configs/CenterNet2_R2-101-DCN-BiFPN_1280_4x.yaml MODEL.WEIGHTS ../projects/CenterNet2/output/Centerent2/OCenterNet2_R2-101-DCN-BiFPN_1280_4x/model_0139999.pth
"""
    )
    parser.add_argument(
        "--tasks",
